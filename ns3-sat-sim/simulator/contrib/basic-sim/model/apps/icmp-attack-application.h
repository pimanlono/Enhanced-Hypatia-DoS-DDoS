...
#ifndef ICMP_ATTACK_APPLICATION_H
#define ICMP_ATTACK_APPLICATION_H
...
class IcmpAttackApplication : public Application 
{
public:
  static TypeId GetTypeId (void);
  IcmpAttackApplication ();
  virtual ~IcmpAttackApplication ();
...
#endif /* ICMP_ATTACK_APPLICATION_H */
