...
/usr/bin/pip3 install numpy astropy ephem networkx sgp4 geopy matplotlib statsmodels || exit 1
...
/usr/bin/pip3 install git+https://github.com/snkas/exputilpy.git@v1.6 || exit 1
/usr/bin/pip3 install cartopy || exit 1
...
/usr/bin/pip3 install numpy statsmodels || exit 1
/usr/bin/pip3 install git+https://github.com/snkas/exputilpy.git@v1.6 || exit 1
...
/usr/bin/pip3 install numpy || exit 1
/usr/bin/pip3 install git+https://github.com/snkas/exputilpy.git@v1.6 || exit 1
/usr/bin/pip3 install git+https://github.com/snkas/networkload.git@v1.3 || exit 1
